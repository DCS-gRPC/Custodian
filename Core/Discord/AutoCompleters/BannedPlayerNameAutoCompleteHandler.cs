...
{
    public sealed class BannedPlayerNameAutoCompleteHandler : AutocompleteHandler
    {
        private static readonly ActivitySource Source = new(nameof(BannedPlayerNameAutoCompleteHandler));

        private readonly ILogger<BannedPlayerNameAutoCompleteHandler> _logger;
        private readonly PlayerService _playerService;

        public BannedPlayerNameAutoCompleteHandler(ILogger<BannedPlayerNameAutoCompleteHandler> logger, PlayerService playerService)
        {
            _logger = logger;
            ...
            IServiceProvider services)
        {
            ...
            var players = await _playerService.GetBannedPlayersOnServerAsync(server);
